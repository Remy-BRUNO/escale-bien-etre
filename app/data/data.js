export const homeData = {
  presentation: {
    ...
    title: "Pause douceur, de sérénité...",
    subTitle: "En Savoie",
    description:
...
export const benefitsData = {
  presentation: {
    ...
    intro:
      "Une séance de massage pratiquée par mes soins, par passion et bienveillance débute par un accueil chaleureux. Avant le début de la séance, un moment d'échange ensemble sera réalisé pour comprendre vos préférences, vos besoins spécifiques et les zones à cibler pendant le massage. Vous serez invité à vous allonger sur ma table confortable de massage généralement dévêtu pour certains soins et recouvert d'une serviette douce, assurant un confort et un respect de l'intimité maximale. Vous plongerez dans une bulle de bien-être, laisserez vous guider et porter par mes gestes amples, souples, enveloppants, stimulants et doux... Une ambiance et un massage cocooning rien que pour vous! Au plaisir de vous voir à mes côtés et de vous apporter le meilleur accompagnement bien-être!",
  },
  ambiences: {
    title: "Les ambiances",
    intro: "",
  ...
  massages: [
    ...
    },
    {
      ...
      prices: {
        firstPrice: "<u>pied/main</u><br> 30min - 40€",
        secondPrice: "<u>option Ayurvédique</u><br> 1h - 85€",
      },
    },
    {
      environment: "massage eveil & sens",
